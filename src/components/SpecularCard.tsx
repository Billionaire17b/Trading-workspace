...
export default function SpecularCard({
  ...
  useEffect(() => {
    ...
    const update = (now: number) => {
      ...
      const p = propsRef.current as {
        speed: number; followMouse: boolean; autoAnimate: boolean;
        lineColor: string; baseColor: string; intensity: number;
        shineSize: number; shineFade: number; thickness: number; radius: number;
      };
  ...
  return (
    <div
      ...
      style={{ '--sc-radius': `${radius}px` } as React.CSSProperties}
      onClick={onClick}
    >
